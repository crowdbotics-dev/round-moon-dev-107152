"""
Django settings for round_moon_dev_107152 project.
...
ROOT_URLCONF = 'round_moon_dev_107152.urls'
...
WSGI_APPLICATION = 'round_moon_dev_107152.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_moon_dev_107152 API",
    "DESCRIPTION": "API documentation for round_moon_dev_107152 App",
    "VERSION": "v1",
}
